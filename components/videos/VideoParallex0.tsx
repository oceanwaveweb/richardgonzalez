      ...
      <div className="relative flex flex-row-reverse h-[calc(100vh-85px)] w-full">
        ...
        <div className="w-[40%] bg-black relative">
          ...
          <div className="absolute top-[20%] left-[10%] text-white space-y-6">
            ...
            <p className="text-lg opacity-80 max-w-[90%]  leading-relaxed">
              “El Juego” is not just a song; it’s a statement. A cry to say
              enough, to reclaim self-love, and to stop being just another piece
              on someone else’s emotional game board.
            </p>
            <Link
              href="https://youtu.be/QWejw_JWfDg?si=kS5S97gfStFbIdLD"
              target="_blank"
        ...
        <div className="w-[60%] h-[96%] relative">
          ...
          <video
            ...
            playsInline={true}
            preload="metadata"
            poster="https://static.found.ee/user/292289/res-bc9151d3-e682-4d49-86b0-298473af159e-El-Juego3.jpg"
            className="w-full h-full object-cover"
            onPlay={() => setIsPlaying(true)}
            onPause={() => setIsPlaying(false)}
          >
            <source src="/eljeugo.mp4" type="video/mp4" />
